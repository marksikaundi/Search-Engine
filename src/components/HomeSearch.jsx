  ...
  return (
    <>
      <form
        ...
        className="flex w-full mt-5 mx-auto max-w-[90%]  hover:shadow-md focus-within:shadow-md transition-shadow border border-gray-200 px-5 py-3 rounded-full sm:max-w-xl lg:max-w-2xl"
      >
